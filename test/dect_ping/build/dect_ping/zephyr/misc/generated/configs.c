...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_SHMEM_TX_SIZE, 24576);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_SHMEM_RX_SIZE, 12288);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_SPM_LOG_LEVEL_DEBUG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 16384);
